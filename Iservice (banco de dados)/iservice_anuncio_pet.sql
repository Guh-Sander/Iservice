...
CREATE TABLE `anuncio_pet` (
  ...
  PRIMARY KEY (`classe_pet`,`cliente_id_cliente`),
  KEY `fk_anuncio_pet_cliente1_idx` (`cliente_id_cliente`),
  CONSTRAINT `fk_anuncio_pet_cliente1` FOREIGN KEY (`cliente_id_cliente`) REFERENCES `cliente` (`id_cliente`)
