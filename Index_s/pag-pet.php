...
<body> 
    ...
    <br>
    <p>Clínica veterinário</p>
    <br>
        <ul>
            <li class="anuncio">    
                <a href="">    
                    <figure>
                        <img src="../images/anuncio_veterinario_1.jpg" title="Dog Center" alt="Imagem da clínica veterianaria para agendamento de consultas ou exames."/>
                        <figcaption>Agropecuária Dog Center NH</figcaption>
                    </figure>
                </a>
            </li>
            <li class="anuncio">
            ...
            <li class="anuncio">
                <a href="">
                    <figure>
                        ...
                        <figcaption>Lumas banho e Tosa NH</figcaption>
                    </figure>
                </a>
            </li>
            <li class="anuncio">
