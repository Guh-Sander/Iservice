    ...
    <nav class="MenuHorizontal"> 
        ...
        <ul class="retiraNumeraLista listaHorizontal centralizaVertical espacingLista">
            <div class="MenuInlineBlock espacingLista2" style="display: none;">
                ...
                <li class="category MenuBlock"><a href="pag-saude.php" style="color: #A42FC2;"><img class="widthLocal escondeIconCell" src="../images/heart.svg"/><span class="escondeNameCell">Saúde</span></a></li>
            ...
            <li class="category escondeMainMenu"><a href="pag-saude.php" style="color: #A42FC2;"><img class="widthHome widthLocal" src="../images/heart.svg"/><span class="escondeNameCell">Saúde</span></a></li>
            ...
            if (isset($_SESSION['cliente'])) {
                ...
                echo '<li class="escondeLogin"><a class="logar" href="login.html"><img class="width" src="../images/person.svg"/><span class="escondeLoginName">Login/Cadastrar</span></a></li>';
            }
            ?>
    ...
    <br>
        <ul>
            <li class="anuncio">    
                <a href="">    
                    <figure>
                        <img src="../images/anuncio_c.odontologia_1.jpg" title="Clareamento dental" alt="Imagem do anúncio de consulta para clarreamento dental."/>
                        <figcaption>Clareamento dental NH</figcaption>
                    </figure>
                </a>
            </li>
            <li class="anuncio">
                <a href="">
                    <figure>
                        <img src="../images/anuncio_c.odontologia_1.jpg" title="Cirurgias implantes e prótesses" alt="Imagem do anúncio para marcação de cirurgias, implantes e prótesses."/>
                        <figcaption>Cirurgias implantes e próteses NH</figcaption>
                    </figure>
                </a>
            </li>
            <li class="anuncio">
                <a href="">
                    <figure>
                        <img src="../images/anuncio_c.odontologia_1.jpg" title="Limpeza dental" alt="Imagem do anúncio de consulta para limpeza dental."/>
                        <figcaption>Limpeza dental NH</figcaption>
                    </figure>
                </a>
            </li>
            <li class="anuncio">
                <a href="">
                    <figure>
                        <img src="../images/anuncio_c.odontologia_1.jpg" title="Marcação para revisão" alt="Imagem do anúncio para marcação de revisão oral."/>
                        <figcaption>Marcação para revisão NH</figcaption>
                    </figure>
                </a>
            </li>
        </ul>
        <p id="cm">Consultório médico</p>
        <br>
        <ul>
            <li class="anuncio">    
                <a href="">    
                    <figure>
                        <img src="../images/anuncio_c.medico_1.jpeg" title="Pediatria" alt="Imagem do anúncio de consulta de pediatria."/>
                        <figcaption>Pediatria NH</figcaption>
                    </figure>
                </a>
            </li>
            <li class="anuncio">
                <a href="">
                    <figure>
                        <img src="../images/anuncio_c.medico_1.jpeg" title="Clínica geral" alt="Imagem do anúncio de consulta na Clínica geral."/>
                        <figcaption>Clínica geral NH</figcaption>
                    </figure>
                </a>
            </li>
            <li class="anuncio">
                <a href="">
                    <figure>
                        <img src="../images/anuncio_c.medico_1.jpeg" title="Marcação de Raio-X" alt="Imagem do anúncio de marcação de Raio-X"/>
                        <figcaption>Marção raio-x NH</figcaption>
                    </figure>
                </a>
            </li>
            <li class="anuncio">
                <a href="">
                    <figure>
                        <img src="../images/anuncio_c.medico_1.jpeg" title="Consulta médica" alt="Imagem do anúncio de consulta médica."/>
                        <figcaption>Consulta médica NH</figcaption>
                    </figure>
                </a>
            </li>
        </ul>
